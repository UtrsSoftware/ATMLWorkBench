...
{
	public partial class HelpMessagezzzzBean : BASEBean
	{
		public static readonly System.String _TABLE_NAME = "help_messagezzzz";
		...
		public HelpMessagezzzzBean( ):base( _TABLE_NAME )
		{
			if( fieldMap.ContainsKey(_MESSAGE_KEY) )
		...
		public HelpMessagezzzzBean( OleDbDataReader reader ):base( _TABLE_NAME )
		{
			if( fieldMap.ContainsKey(_MESSAGE_KEY) )
