  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        <div id="page" >
          <h1>
            <xsl:value-of select="/about/product/title" />
          </h1>
          <h3>Description</h3>
          <p>
            <xsl:value-of select="/about/product/description"  disable-output-escaping="yes" />
          </p>
          ...
          <h3>License</h3>
          <p>
            <xsl:value-of select="/about/product/license" disable-output-escaping="yes" />
          </p>
          <h3>Contributors</h3>
            ...
            <ul id="libraries" >
              <xsl:for-each select="/about/libraries/library" >
                <li>
                  ...
                  <br/>
                  <p>
                    <xsl:value-of select="license" disable-output-escaping="yes" />
                  </p>
                </li>
              </xsl:for-each>
            </ul>
