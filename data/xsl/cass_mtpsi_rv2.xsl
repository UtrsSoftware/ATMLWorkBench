                    ...
                    <xsl:element name="TestedUUT" >
                        ...
                        <xsl:if test="$uuid!=''" >
                            <xsl:element name="c:DescriptionDocumentReference"  >
                                <xsl:attribute name="id" ><xsl:value-of select="$model" /></xsl:attribute>
                        ...
                        <!-- Iterate Instruments     -->
												<xsl:for-each select="/tpsi:CASS_MTPSI/tpsi:CASS_MTPSI_page/tpsi:ATE_assets[@Station=$station]" >
														...
														<xsl:element name="Instrumentation" >
																<xsl:element name="c:DescriptionDocumentReference" >
																		<xsl:attribute name="ID" ><xsl:value-of select="@Asset_Identifier" /></xsl:attribute>
																		<xsl:attribute name="uuid" >
												...
												<xsl:for-each select="/tpsi:CASS_MTPSI/tpsi:CASS_MTPSI_page/tpsi:ATE_assets[not(@Station)]" >
														<xsl:variable name="assetId" select="@Asset_Identifier" />
														<xsl:element name="Instrumentation" >
																<xsl:element name="c:DescriptionDocumentReference" >
																		<xsl:attribute name="ID" ><xsl:value-of select="@Asset_Identifier" /></xsl:attribute>
